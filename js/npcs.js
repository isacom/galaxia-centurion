...
const NPCS = [
  ...
  },
  {
    ...
    specialization: "Atormentar a Unkown",
    faction: "Desconocida",
    factionIcon: "assets/icons/factions/neutral.png",
  ...
  {
    name: "Wilhelm",
    avatar: "assets/images/npcs/willhelm/IconoWilhelm.jpg",
    specialization: "Matar",
    faction: "Hyperion",
    factionIcon: "assets/icons/factions/hyperion.png",
    shortDescription: "Mercenario a sueldo modificado hasta los dientes con un armazón desconocido que lo hace invulnerable a casi cualquier daño, armado con distintos implantes que lo hacen letal y con modificaciones que lo mejoran en todo aspecto. Wilhelm a cambiado mucho a lo largo de los años llegando a ser la cuspide de lo que es conocido como un constructo.",
    image: "assets/images/npcs/willhelm/FotoWilhelm.jpg",
    sound: "assets/audio/locations/SoundEffect.mp3",
  },
  {
    name: "Doctor Zed",
  ...
  {
    name: "Ciris Ian Smith (Cis)",
    avatar: "assets/images/npcs/cis/IconoCis.jpg",
    specialization: "Slicing, Combatiente",
    faction: "N/A",
    factionIcon: "assets/icons/factions/neutral.png",
    shortDescription: "Mujer humana de 1,79m de altura con gran cabello blanquecino protésico, iris de color rojo, rasgos afilados mostrando siempre un rostro serio, labios pintados de rojo oscuro, pestañas perfiladas y maquillada de blanco como una geisha. Su complexión es delgada pero definida luciendola mediante un traje de neturunner de combate ajustado siempre consigo.",
    image: "assets/images/npcs/cis/FotoCis.jpg",
    sound: "assets/audio/locations/SoundEffect.mp3",
  },
  {
    name: "Katarina-Henrié",
    avatar: "assets/images/npcs/katarina/IconoKatarina.jpg",
    specialization: "¿?, Tarot",
    faction: "Junkertown",
    factionIcon: "assets/icons/factions/junkertown.png",
    shortDescription: "Mujer humana de avanzada edad de unos 50 años, tiene cicatrices por su rostro y cuerpo indicando un ataque de hace años, su cabello es negro y largo pero canoso, ojos de color rojo, lleva dos protesis que sustituyen sus piernas hechas de bronce y con tacones con toques ostentosos, suele llevar túnicas y abalorios ostentosos similares a misticistas rumanicas, tiene muchos cables y tubos conectados a su cabeza que van hacia una especie de maquina atada a su espalda de la cual hay 3 calaveras metálicas flotando conectadas a cables que siempre la acompañan.",
    image: "assets/images/npcs/katarina/FotoKatarina.jpg",
    sound: "assets/audio/locations/SoundEffect.mp3",
  },
  {
    name: "Mitth'Vindicta",
    avatar: "assets/images/npcs/vindicta/IconoVindicta.jpg",
    specialization: "Francotirador, Toxicóloga",
    faction: "N/A",
    factionIcon: "assets/icons/factions/neutral.png",
    shortDescription: "Mujer chiss de 1,68m de altura con piel azul clara, pelo largo blanquecino acabado en trenza, ojos rojos, labios pintados de un morado apagado, su complexión es delgada y flexible perfecta para sus misiones llevando consigo siempre un vestido rojo oscuro, además nunca lleva zapatos.",
    image: "assets/images/npcs/vindicta/FotoVindicta.jpg",
    sound: "assets/audio/locations/SoundEffect.mp3",
  },
  {
    name: "Junkrat",
    avatar: "assets/images/npcs/junkrat/IconoJunkrat.jpg",
    specialization: "Explosivos, Robos",
    faction: "Junkertown",
    factionIcon: "assets/icons/factions/junkertown.png",
    shortDescription: "Hombre humano delgado de 1,70m de altura con la piel oscurecida por el uso de polvora y exposición al sol, tiene un pelo encrespado rubio a medio quemar, un cinturón repleto de granadas explosivas, un brazo derecho protesico y una pata de palo en la pierna derecha.",
    image: "assets/images/npcs/junkrat/FotoJunkrat.jpg",
    sound: "assets/audio/locations/SoundEffect.mp3",
  },
  {
    name: "Roadhog",
    avatar: "assets/images/npcs/roadhog/IconoRoadhog.jpg",
    specialization: "Mecanica, Carnicero",
    faction: "Junkertown",
    factionIcon: "assets/icons/factions/junkertown.png",
    shortDescription: "Hombre humano obeso pero con musculo de 2,10m de altura con la piel repleta de tatuajes morteros, lleva diversos anillos en los dedos, un pequeño chaleco hecho a base de neumáticos, una máscara de gas con forma de cerdo y un cabello blanco con coleta.",
    image: "assets/images/npcs/roadhog/FotoRoadhog.jpg",
    sound: "assets/audio/locations/SoundEffect.mp3",
  },
  {
    name: "Jax",
    avatar: "assets/images/npcs/jax/IconoJax.jpg",
    specialization: "Cirujía, Implantes",
    faction: "Junkertown",
    factionIcon: "assets/icons/factions/junkertown.png",
    shortDescription: "Hombre humano de 2m de altura con diversas modificaciones por tota su piel incluido sus brazos, cuenta con implantes ópticos que hacen que sus ojos sean rojos y tiene un rostro afilado junto con un pelo grisáceo alocado.",
    image: "assets/images/npcs/jax/FotoJax.jpg",
    sound: "assets/audio/locations/SoundEffect.mp3",
  },
  {
    name: "Grimskull",
    avatar: "assets/images/npcs/grimskull/IconoGrimskull.jpg",
    specialization: "WAAAAAGH",
    faction: "Junkertown",
    factionIcon: "assets/icons/factions/junkertown.png",
    shortDescription: "Grande i fuerrte zoi.",
    image: "assets/images/npcs/grimskull/FotoGrimskull.jpg",
    sound: "assets/audio/locations/SoundEffect.mp3",
  },
  {
    name: "¿? (Junker Queen)",
    avatar: "assets/images/npcs/queen/IconoQueen.jpg",
    specialization: "Reinar, Chatarrera",
    faction: "Junkertown",
    factionIcon: "assets/icons/factions/junkertown.png",
    shortDescription: "Mujer humana con 2,10m de estatura combinada con una gran musculatura, uñas pintadas de negro mediante alquitran, ojos rojos debido al suero del supersoldado, cabellos largos azules que combina mediante trenzas en los laterales de la cabeza y una creta, varios piercings y pinchos por el rostr además de unas ojeras pintadas de gris para dar un aspecto amenazante. ",
    image: "assets/images/npcs/queen/FotoQueen.jpg",
    sound: "assets/audio/locations/SoundEffect.mp3",
  },
];
